const SymbolContent = ()=>{
    return (
        ...
        <ul>
            <li><b>Text Messages</b>:You can Embedding text faces within text messages or chat dialogues serves to infuse emotions and individuality into your written exchanges.</li>
